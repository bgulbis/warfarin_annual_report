...
Utilization of the Pharmacy-Managed Warfarin Dosing Service continued to increase in FY18. The areas with the highest utilization were Rehab and areas of HVI. Patients managed by pharmacy had a greater time in therapeutic range. 

# Service Utilization

There has been a `r chg_pharm`% increase in the number of warfarin patients being managed by the Pharmacy Dosing Service over the past two fiscal years (see Figure 1). Conversely, there has been a `r chg_trad`% decrease in patients with traditional warfarin management (warfarin managed by a physician or advanced practice provider) during this time. 
...
The highest volume of warfarin use occured in the Heart Failure IMU, followed by CIMU and CVIMU (see Figure 2). Utilization of the Pharmacy Dosing Service remains low in HFIMU, although Clinical Pharmacists and Clinical Pharmacist-Specialists participate in the management of warfarin in both of these areas.
...
There were no differences in bleeding, need for anticoagulation reversal, readmission within 30 dyas, or other adverse events (see Table 1).
...
tbl_hgb %>%
    ...
    knitr::kable(
        ...
        caption = "Outcomes and Events During Warfarin Therapy. Hemoglobin decrease of >/= 2 g/dL within a 48-hour period. Vizient metric assesses the percent of patients on warfarin for more than two days who experience an INR >/= 5 at any point during the hospitalization after warfarin initation. Reversal medications included phytonadione, 4-factor PCC, factor VIIa, aminocaproic acid, or tranexamic acid. Unplanned return included any ER visit, observation, or inpatient stay at any MH hospital within 30 days of discharge from MH-TMC."
    ) %>%
