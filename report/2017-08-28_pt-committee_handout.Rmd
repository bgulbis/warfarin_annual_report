...
In looking at the warfarin doses administered on each of the first 7 days of therapy, there is a higher initial dose ordered by the Pharmacy Dosing Service (see Figure 4).
...
```{r, fig.cap="INR response during the first 7 days of warfarin therapy. The p-value was < 0.001 for all days except day 3 (p = 0.038) and day 4 (p = 0.388). Patients with an INR target below 2 were excluded from this figure. The usual therapeutic INR range of 2 to 3 is shaded."}
inr <- data_daily %>%
...
data_hgb_drop %>%
    ...
    knitr::kable(digits = 1, caption = "Hemoglobin decrease by >/= 2 g/dL within a 48-hour period")
```
