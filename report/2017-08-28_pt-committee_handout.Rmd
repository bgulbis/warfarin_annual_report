...
```{r, fig.cap="Top 10 hospital units administering warfarin in FY17. For comparison, FY16 data is provided: the X indicates warfarin managed by Pharmacy Dosing Service in each unit in FY16, the | indicates the total warfarin in each unit in FY16."}
